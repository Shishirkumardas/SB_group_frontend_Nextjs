...
export default function CashbackDetailsPage() {
    ...
    useEffect(() => {
        ...
        const fetchAll = async () => {
            try {
                const cashbackRes = await fetch(`http://localhost:8080/api/shoppingmall-cashback/${id}`, {
                    credentials: "include",
                });
                ...
                const paymentsRes = await fetch(`http://localhost:8080/api/shoppingmall-cashback/${id}/payments`, {
                    credentials: "include",
                });
        ...
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="mt-10 text-center">
                    <button
                        onClick={() => router.push(`/shoppingmall-cashback/${id}/pay`)}
