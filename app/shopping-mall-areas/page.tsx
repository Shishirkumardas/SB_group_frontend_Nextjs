...
import AreaForm from "@/components/ShoppingMallAreaForm";
...
export default function ShoppingMallAreasPage() {
    const [areas, setAreas] = useState<Area[]>([]);
    const API_URL = "http://localhost:8080/api/shoppingmall-areas";
